...
class Trader:
    ...
    def __init__(self):
        ...
        self.last_ema_price = {'AMETHYSTS': 10000, 'STARFRUIT': 4900}
        ...
        for product in state.order_depths.keys():
            ...
            if product == 'AMETHYSTS':
                ...
                if len(order_depth.sell_orders) > 0 and len(order_depth.buy_orders) > 0: # 双边都有挂单
                    ...
                    # taker strategy
                    if best_ask <= acceptable_price: # take the sell order on the orderbook as much as possible
                    ...
                    if best_bid >= acceptable_price: #take the buy order on the orderbook as much as possible
            ...
            if product == 'STARFRUIT':
                ...
                # Calculate the mid price of the AMETHYSTS market
